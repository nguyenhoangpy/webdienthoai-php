...
if ($email == false) {
    ...
    echo "<div class='alert alert-warning' role='alert'>Tạo mật khẩu mới mà bạn chưa từng sử dụng trên website này.</div>";
}
?>
    <header>
        ...
        <div class="row">
            ...
            <div class="col-5">
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="submit" name="change-password" class="btn btn-outline-success btn-block" style="text-align: center;" value="Xác minh tài khoản">
                    </div>
                </form>
            </div>
            <div class="col">
