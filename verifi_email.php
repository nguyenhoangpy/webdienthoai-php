...
if (isset($_SESSION['email'])) {
    echo "<div class='alert alert-success' role='alert'>Đã gửi email chứa mã xác minh tới - ".$_SESSION['email'].". Vui lòng kiểm tra email. </div>";
}
        ...
        <div class="row">
            ...
            <div class="col-5">
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="submit" name="checkcode_signup" class="btn btn-outline-success btn-block" style="text-align: center;" value="Xác minh tài khoản">
                    </div>
                </form>
            </div>
            <div class="col">
