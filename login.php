        ...
        <div class="row">
            ...
            <div class="col-5">
                <form method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <small><a href="forgot_pwd.php">Quên mật khẩu</a></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <small>Bạn chưa có tài khoản? <a href="signup.php">Đăng ký ngay</a> hoặc</small>
                    </div>
                    <div class="form-group">
                        <a href="<?= $facebook_login_url; ?>"><button type="button" class="btn btn-primary btn-block">Đăng nhập bằng Facebook</button></a>
                    </div>
                    <div class="form-group">
                        <?php if (isset($google_login_url)) { ?>
                            <a href="<?= $google_login_url; ?>"><button type="button" class="btn btn btn-danger btn-block">Đăng nhập bằng Google</button></a>
                        <?php } ?>
                    </div>
                </form>
            </div>
